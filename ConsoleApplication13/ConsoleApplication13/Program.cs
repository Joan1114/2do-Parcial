...
namespace ConsoleApplication13
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n" + candidatos[0] + " obtuvo " + voto1 + " votos y un porcetaje de " + candidato1 + "%");
            Console.WriteLine("\n" + candidatos[1] + " obtuvo " + voto2 + " votos y un porcetaje de " + candidato2 + "%");
            Console.WriteLine("\n" + candidatos[2] + " obtuvo " + voto3 + " votos y un porcetaje de " + candidato3 + "%"); 
            Console.WriteLine("\n" + candidatos[3] + " obtuvo " + voto4 + " votos y un porcetaje de " + candidato4 + "%");

            if (voto1 > voto2 && voto1 > voto3 && voto1 > voto4)
            {
                Console.WriteLine("\nEl ganador de las elecciones es: " + candidatos[0]);
            } if (voto2 > voto1 && voto2 > voto3 && voto2 > voto4)
            {
                Console.WriteLine("\nEl ganador de las elecciones es: " + candidatos[1]);
            } if (voto3 > voto1 && voto3 > voto2 && voto3 > voto4)
            {
                Console.WriteLine("\nEl ganador de las elecciones es: " + candidatos[2]);
            } if (voto4 > voto1 && voto4 > voto2 && voto4 > voto3)
            {
                Console.WriteLine("\nEl ganador de las elecciones es: " + candidatos[3]);
            }
